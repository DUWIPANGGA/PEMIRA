<x-app-layout>
    ...
    <div class="relative w-screen h-screen m-0 bg-cover bg-center flex justify-center items-center overflow-hidden"
        ...
        <!-- Text -->
        <h1 class="text-dark text-center text-4xl font-bold hero-text transition-all duration-1000 ease-in-out z-10"
            id="text-container">
            WHO'S <br> THE NEXT!!
        </h1>
    ...
    <div class="relative w-full min-h-screen pt-20 z-10"
        style="
        background-image: url({{ asset('image/background/paperb.png') }});
        background-repeat: no-repeat;
        background-size: 100% 190%;
        background-position: bottom;
        margin-top: -190px; /* Biar masuk ke hero */
    ">
        <div class="container mx-auto px-4 py-12 flex flex-col md:flex-row items-end justify-center gap-8 ">
            <!-- Gambar + Judul -->
            ...
            <div class="bg-white border-4 border-red-500 rounded-3xl p-6 max-w-xl relative shadow-lg">
                ...
                <div class="absolute bottom-0 left-0 right-0 h-4 bg-[url('/path/to/dashed.png')] bg-repeat-x bg-center">
                </div>
            </div>
        </div>
    </div>
    <div class="relative w-full min-h-screen pt-20 z-10"
    style="
    background-image: url({{ asset('image/background/paper.png') }});
    background-repeat: no-repeat;
    background-size: 100% 100%;
    background-position: bottom;
    margin-top: -400px; /* Biar masuk ke hero */
"></div>
<div class="container flex flex-col justify-center items-center">
    <h1 class="text-dark text-center text-4xl font-bold hero-text transition-all duration-1000 ease-in-out z-10 pb-10"
            id="text-container">
            TIMELANE
        </h1>
